class Solver {
    ...
    createSinglesObject() {
        ...
        if (this.solvedCount == this.questionsCount) {
            ...
            console.log("Yönetim Kurulu Çözüldü: createSinglesObject attempt 1");
        }else{
            this.singlesFinder()
        }
    ...
    singlesFinder() {
        ...
        if (this.solvedCount == this.questionsCount) {
            this.isBoardSolved = true;
            console.log("Tek: tahta çözüldü");
            //validate the board
            let isSolutionValid = this.boardValidation()
            if(isSolutionValid) console.log('Tek: çözüm geçerli bir sudokudur');
            alert('Otomatik Kurulu Çözüldü')
        }
        console.log(`Tek: ${this.solvedCount} filled out of ${this.questionsCount}`);
    }
    ...
    async backTracking(){        
        ...
        if(this.boardValidation()){
            console.log('backTracking Tamamlandı: Tahta Çözüldü');
            alert('Oyun otomatik çözüldü')
        }else{
            console.log('backTracking Tamamlandı: Çözüm bulunamadı');
        }
